...
const ROLES = [
  {
    ...
    puntos: [
      'Registrás objetivos con evidencia: avances, archivos y links verificables',
      'Pedís validaciones a clientes — valen el 35% del Índice TRAZA',
      'El cierre semanal (3 preguntas) suma regularidad y construye tu historial',
      'Tu credencial portátil y tu informe PDF son tuyos para toda la carrera',
    ],
  ...
  },
  {
    ...
    puntos: [
      'Gestionás objetivos asignados por tu empresa y los que agregaste vos',
      'Tu manager valida lo que completás — eso vale el 35% del Índice',
      'El cierre semanal le da contexto al manager sin reuniones de status',
      'Tu historial verificado es tuyo: te acompaña cuando cambiás de trabajo',
    ],
  ...
  },
  {
    ...
    puntos: [
      'Ves el Índice TRAZA de cada colaborador y sus objetivos en tiempo real',
      'Validás objetivos completados — ese aval vale el 35% del score del colaborador',
      'Detectás señales automáticas: quién no registra avances y objetivos en riesgo',
      'Generás evaluaciones formales y exportás reportes en PDF o Excel',
    ],
