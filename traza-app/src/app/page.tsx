...
const FAQ_ITEMS = [
  ...
  { q:'¿Cómo funciona el Índice TRAZA?', a:'El Índice TRAZA es un score de 0 a 100 calculado a partir de 5 dimensiones: Validación de Superiores (35%), Cumplimiento (25%), Regularidad (20%), Alineación (10%) y Proactividad (10%). Se calcula automáticamente en base a objetivos completados, validaciones y avances documentados.' },
